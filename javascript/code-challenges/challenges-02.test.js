...
const addOne = (arr) => {
  let newNum = arr.map(plus1 => plus1 + 1);
  return newNum;
  // Solution code here...
};
...
const addQuestion = (arr) => {
  let q = arr.map(question => question + '?');
  return q;
  // Solution code here...
};
...
const forLoopTwoToThe = (arr) => {
  let newArr = arr.map(p2 => Math.pow(2, p2));
  return newArr;
  // Solution code here...
};
...
const mapTwoToThe = (arr) => {
  let newArr = arr.map(f => Math.pow(2, f));
  return newArr;
  // Solution code here...
};
